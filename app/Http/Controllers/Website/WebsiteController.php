...
class WebsiteController extends Controller
{
    ...
    {  
        // prettychickscare
        $this->theme = env('ACTIVE_THEME','prettychickscare');
    ...
    public function about(){
        return view('theme.prettychickscare.about');
    }   
    public function addtocart(){
        return view('theme.prettychickscare.addtocart');
    }   
    public function checkout(){
        return view('theme.prettychickscare.checkout');
    }   
    public function contact_us(){
        return view('theme.prettychickscare.contact_us');
    }   
    public function product_detail($id){
        $product=Product::find($id);
        return view('theme.prettychickscare.product_detail')->with(['products'=>$product]);
    }   
    public function products(){
        return view('theme.prettychickscare.products');
    }   
    public function services(){
        return view('theme.prettychickscare.services');
    }   
    public function wishlist(){
        return view('theme.prettychickscare.wishlist');
    }   
