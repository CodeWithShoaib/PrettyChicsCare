							...
							<div class="invoice-wrapper">
								...
								<div class="line-items">
									...
									<div class="total text-right">
										...
										@endif
										<div class="field">
											{{ _lang('Sub Total') }} <span>{!! $order->sub_total !!}</span>
										</div>
										<div class="field">
											{{ _lang('Shipping') }} <span>+ {!! $order->shipping_cost !!}</span>
										</div>

										<div class="field">
											{{ _lang('Discount') }} <span>- {!! $order->discount !!}</span>
										</div>

										@foreach($order->taxes as $tax)
											<div class="field">
												{{ $tax->translation->name }} <span>+ {!! $tax->order_tax->amount !!}</span>
											</div>
										@endforeach

										<div class="field grand-total">
											{{ _lang('Total') }} <span>{!! $order->total !!}</span>
										</div>
									</div>
