...
Route::group(['middleware' => ['install']], function () {
	...
	Route::get('/addtocart', 'Website\WebsiteController@addtocart')->name('addtocart');
	Route::get('/checkout', 'Website\WebsiteController@checkout')->name('checkout');
	Route::get('/contact_us', 'Website\WebsiteController@contact_us')->name('contact_us');
	Route::get('/product_detail/{id}', 'Website\WebsiteController@product_detail')->name('product_detail');
	...
	Route::get('/wishlist', 'Website\WebsiteController@wishlist')->name('wishlist');
